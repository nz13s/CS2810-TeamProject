 ...
 * GET - No params
 *
 * @author Nick Bogachev, Jatin Khatra, Bhavik Narang
 */
public class CancelOrder extends HttpServlet {
  private ObjectMapper om = new ObjectMapper();

  /**
   * Configures the {@link ObjectMapper} before being used to serialise the {@link Order}
   * for the frontend, uses the {@link OrderSerialiser}.
   */
  @Override
  public void init() {
    om.configure(SerializationFeature.FAIL_ON_EMPTY_BEANS, false);
    SimpleModule module =
            new SimpleModule("CancelledOrdersSerialiser",
