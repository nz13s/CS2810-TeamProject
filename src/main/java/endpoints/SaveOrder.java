 ...
 * POST - int: table_num
 *
 * @author Oliver Graham, Tony Delchev, Cameron Jones, Jatin Khatra
 */
  ...
  protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws IOException {
    ...
    if (tableSeated == null) {
      ...
      try {
        ...
        //todo maybe need to assign a random water if waiter is
        // not found rather than putting table into looking for staff
        ...
        if (ActiveStaff.findTableWaiter(tableSeated) != null) {
          ...
          NotificationSocket.pushNotification(
                  new SocketMessage(n, SocketMessageType.CREATE),
                  ActiveStaff.findStaffForTable(tableSeated.tableNum));
        }
