 ...
 * POST - int: ID (Order)
 *
 * @author Cameron Jones, Tony Delchev
 */
public class AcceptOrder extends HttpServlet {
  ...
  /**
   * Configures the {@link ObjectMapper} before being used to serialise the Orders Queue for the
   * frontend, uses the {@link QueueSerialiser}.
   */
  @Override
  public void init() {
  ...
  protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws IOException {
    ...
    try {
      ...
      NotificationSocket.pushNotification(new SocketMessage(nfConfirmed,
   ...
   */
  private int getOrderID(HttpServletRequest req, HttpServletResponse resp) throws IOException,
